...
public class CamlLightParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CamlLight");
  ...
  { 
    CamlLightParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CamlLightParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CamlLightParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CamlLightParseControllerGenerated.class);
    }
  ...
  { 
    return CamlLightParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
